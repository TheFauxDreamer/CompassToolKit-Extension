...
clearance sheet from their timetable — one row per subject, with columns for the
teacher, comments and a signature.
...
- **Button position** — which corner the button starts from: bottom left,
...
Turning it off brings the bubble straight back — no reload needed.
